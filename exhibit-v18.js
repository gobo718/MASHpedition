(()=>{
  ...
  const AREA_PRESETS={
    gallery:{mix:'A',label:'GALLERY',count:88,start:'thumbnail'},
    collection:{mix:'B',label:'COLLECTION',count:22,start:'exhibit'},
    fyc:{mix:'A',label:'FOR YOUR CONSIDERATION',count:88,start:'thumbnail'},
    se:{mix:'A',label:'SALON ECLECTIQUE',count:88,start:'thumbnail'},
    geh:{mix:'B',label:'GRAND EXHIBITION HALL',count:22,start:'exhibit',geh:true},
    'cat-theme':{mix:'A',label:'CATACOMBS · THEME SEARCH',count:88,start:'thumbnail'},
    'cat-search':{mix:'C',label:'CATACOMBS · SEARCH',count:88,start:'exhibit'}
  };
